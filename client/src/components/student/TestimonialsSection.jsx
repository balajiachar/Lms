...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3' >hear from our learners as they share their journey of trasnformation,
        success, and how our <br /> plateform has made a different in thier lives.</p>
