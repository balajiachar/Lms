          ...
          {/* review and rating */}
           <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                    ...
                    <p className='text-blue-600'>({courseData.courseRatings.length} 
                      {courseData.courseRatings.length > 1  ?   ' rating' : 'rating'})</p>

                      <p>{courseData.courseRatings.length} 
                        {courseData.courseRatings.length > 1 ? 'students' : 'student'} </p>
                  </div>
                  ...
                  <div className='pt-8 text-gray-800'>
                      ...
                      {courseData.courseContent.map((chapter, index)=> (
                        <div key={index} className='border border-gray-300 bg-white mt-2 rounded'>
                  ...
                  <div className='py-200 text-sm md:text-default'>
